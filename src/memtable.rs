...
mod tests {
    ...
    fn test_put_and_get() {
        ...
        memtable
            .put(b"key1".to_vec(), b"value1".to_vec(), 1000)
            .unwrap();
        memtable
            .put(b"key2".to_vec(), b"value2".to_vec(), 2000)
            .unwrap();
    ...
    fn test_size_tracking() {
        ...
        memtable
            .put(b"key".to_vec(), b"value".to_vec(), 1000)
            .unwrap();
    ...
    fn test_full_detection() {
        ...
        for i in 0..100 {
            ...
            is_full = memtable
                .put(key.into_bytes(), value, 1000 + i as u64)
                .unwrap();
            if is_full {
                break;
            }
    ...
    fn test_scan() {
        ...
        memtable
            .put(b"key3".to_vec(), b"value3".to_vec(), 3000)
            .unwrap();
        memtable
            .put(b"key1".to_vec(), b"value1".to_vec(), 1000)
            .unwrap();
        memtable
            .put(b"key5".to_vec(), b"value5".to_vec(), 5000)
            .unwrap();
        memtable
            .put(b"key2".to_vec(), b"value2".to_vec(), 2000)
            .unwrap();
        memtable
            .put(b"key4".to_vec(), b"value4".to_vec(), 4000)
            .unwrap();
