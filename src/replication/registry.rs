...
mod tests {
    ...
    async fn test_connected_count() {
        ...
        registry.register("replica-1".to_string(), "addr1".to_string(), 0).await;
        registry.register("replica-2".to_string(), "addr2".to_string(), 0).await;
        registry.register("replica-3".to_string(), "addr3".to_string(), 0).await;
